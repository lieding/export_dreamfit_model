...
class DoubleStreamBlockLoraProcessor(ModelMixin):
    def __init__(self, dim: int, rank=4, network_alpha=None, lora_weight=1):
        super().__init__()
        self.ref_qkv_lora_q  = LoRALinearLayer(dim, dim, rank, network_alpha)
        self.ref_qkv_lora_k  = LoRALinearLayer(dim, dim, rank, network_alpha)
        self.ref_qkv_lora_v  = LoRALinearLayer(dim, dim, rank, network_alpha)

        self.ref_proj_lora1 = LoRALinearLayer(dim, dim, rank, network_alpha)
        self.lora_weight = lora_weight
...
class SingleStreamBlockLoraProcessor(ModelMixin):
    def __init__(self, dim: int, rank: int = 4, network_alpha = None, lora_weight: float = 1, ip_scale=1.0):
        super().__init__()
        ...
        self.ref_proj_lora = LoRALinearLayer(15360, dim, rank*2, network_alpha*2)
